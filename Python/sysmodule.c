...
sys_getwindowsversion(PyObject *self)
{
    ...
    PyStructSequence_SET_ITEM(version, pos++, PyLong_FromLong(8250));
    PyStructSequence_SET_ITEM(version, pos++, PyLong_FromLong(2));
    PyStructSequence_SET_ITEM(version, pos++, PyUnicode_FromWideChar(L'\0', 0));
    ...
    PyStructSequence_SET_ITEM(version, pos++, PyUnicode_FromWideChar(ver.szCSDVersion,
        wcslen(ver.szCSDVersion)));
...
sys_update_path(int argc, wchar_t **argv)
{
...
#elif defined(MS_WINDOWS) && !defined(MS_WINCE) && !Py_WIN8APP
    ...
    if (_HAVE_SCRIPT_ARGUMENT(argc, argv)) {
        wchar_t *q;
#if defined(MS_WINDOWS) && !defined(MS_WINCE) && !Py_WIN8APP
