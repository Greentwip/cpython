...
/* Symbolic constants differ between platform SDK and phone SDK:
   In the platform SDK, Desktop is 1 and Metro is 2; in the phone
   SDK, it's reversed. So we need to include the header to find out.*/
#ifdef WINAPI_FAMILY
#include <winapifamily.h>
#define Py_WIN8APP (!WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP))
#else
#define Py_WIN8APP 0
#endif
...
#			if defined(_DEBUG) && WINAPI_FAMILY+0 != 2
